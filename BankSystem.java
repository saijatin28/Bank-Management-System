...
public class BankSystem extends JFrame implements ActionListener, ItemListener {
	...
	public BankSystem () {
		...
		changePass.setMnemonic ((int)'C');
		changePass.addActionListener (this);
		manageCard = new JMenuItem("Manage Card");
		manageCard.setMnemonic((int)'M');
		manageCard.addActionListener(this);
		viewTrans = new JMenuItem("View Transactions");
		viewTrans.setMnemonic((int)'V');
		...
		mnuEdit.add (delRec);
		mnuEdit.addSeparator ();
		mnuEdit.add (changePass);
		mnuEdit.add(manageCard);
		mnuEdit.add (search);
		mnuEdit.add (searchName);

		//View Menu Items.
		mnuView.add(viewTrans);
	...
	public void actionPerformed (ActionEvent ae) {
		...
		else if (obj == addNew || obj == open || obj == btnNew) {
		...
		else if (obj == manageCard) {
			boolean b = openChildWindow ("Manage Card");
			if (b == false) {
		...
		else if (obj == viewTrans) {
			boolean b = openChildWindow("View Transaction");
			if (b == false) {
