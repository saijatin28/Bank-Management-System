...
//	private DataInputStream dis;
	...
	DeleteCustomer () {
		...
		txtPass.setBounds (125, 160, 200, 25);

		//Aligning The Buttons.
		btnDel = new JButton ("Delete");
		btnDel.setBounds (20, 190, 120, 25);
		btnDel.addActionListener (this);
		btnCancel = new JButton ("Cancel");
		btnCancel.setBounds (200, 190, 120, 25);
		...
		txtNo.addFocusListener (new FocusListener () {
			...
			//			System.out.println("Creating table in given database..."); 
						...
						String sql;
						sql = "select * from data where acno='"+txtNo.getText()+"'";
						var rs = stmt.executeQuery(sql);
						if (rs.next()) {
							txtNo.setText(rs.getString(1));
							txtName.setText(rs.getString(2));
							txtDate.setText(rs.getString(3)+", "+rs.getString(4)+", "+rs.getString(5));
...
//			System.out.println("Created table in given database..."); 
		...
		if (obj == btnDel) {
			...
			else if (!txtPass.getText().equals(realPass)) {
				JOptionPane.showMessageDialog (this, "Please! Provide Correct Password.",
...
//			System.out.println("Creating table in given database..."); 
			...
			if (rs.next()) {
				...
				txtDate.setText(rs.getString(3)+", "+rs.getString(4)+", "+rs.getString(5));
				txtBal.setText(rs.getString(6));
				sql = "delete from data where acno='"+txtNo.getText()+"'";
